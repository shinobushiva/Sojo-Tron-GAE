...
public class TronMap {
    ...
    public TronMap(InputStream s) {
        readFromStream(s);
    }

    public TronMap(Reader s) {
        readFromReader(s);
    }
    ...
    public void readFromFile(String s) {
        try {
            readFromStream(new FileInputStream(s));
    ...
    public void readFromStream(InputStream is) {
        readFromReader(new InputStreamReader(is));
    }

    public void readFromReader(Reader is) {
                        ...
                        if (flag) {
                            System.err
                                .println((new StringBuilder())
                                    ...
                                    .append(getPlayerOneLocation().getX())
                                    .append(",")
                                    .append(getPlayerOneLocation().getY())
                        ...
                        if (flag1) {
                            System.err
                                .println((new StringBuilder())
                                    ...
                                    .append(getPlayerTwoLocation().getX())
                                    .append(",")
                                    .append(getPlayerTwoLocation().getY())
                                    .append("), ")
                                    .append("second location is (")
                                    .append(k)
                                    .append(",")
